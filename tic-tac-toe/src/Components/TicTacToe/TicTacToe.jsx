...
export const TicTacToe = () => {
  ...
  const won = (winner) => {
    ...
    if(winner === "x")
    {
        titleRef.current.innerHTML = `Player with the X is the Winner!!!`;
    }
    else
    {
        titleRef.current.innerHTML = `Player with the O is the Winner!!!`;
    }
  }
  ...
  const reset = () => {
    setLock(false);
    data = ["", "", "","", "", "","", "", ""];
    titleRef.current.innerHTML = "Tic Tac Toe game restarted!";
    box_array.map((e) => {
        e.current.innerHTML = "";
    })
  }
